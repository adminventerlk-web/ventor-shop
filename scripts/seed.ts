...
async function seed() {
  ...
  const prodSoap = await Product.create({
    ...
    images: ['https://images.unsplash.com/photo-1607006482602-76ca0fd20b4d?auto=format&fit=crop&w=800&q=80'],
    retailPrice: 8.5,
    communityPrice: 7.25,
    wholesalePrice: 5.0,
    stock: 350,
  ...
  const prodGhee = await Product.create({
    ...
    images: ['https://images.unsplash.com/photo-1628088062854-d1870b4553da?auto=format&fit=crop&w=800&q=80'],
    retailPrice: 24.99,
    communityPrice: 21.5,
    wholesalePrice: 17.0,
    stock: 110,
  ...
  const prodCookware = await Product.create({
    ...
    images: ['https://images.unsplash.com/photo-1590794056226-79ef3a8147e1?auto=format&fit=crop&w=800&q=80'],
    retailPrice: 39.99,
    communityPrice: 34.5,
    wholesalePrice: 26.0,
    stock: 40,
